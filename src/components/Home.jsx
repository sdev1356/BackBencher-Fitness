        ...
        <main>
            ...
            <video autoPlay playsInline muted loop className="hero-video">
                ...
                <div className="hero-heading">
                    <h2 className="handing__header--subheading">
                        <span className="header-logo">Backbencher Fitness</span><br/>Everybody Needs a Tune-Up
                    </h2>
                ...
                <button className="next-btn"aria-label="Discover Bakbencher's"onClick={()=>document.getElementById('about').scrollIntoView()}>
                    <FaAngleDown/>
                </button>
                </header>
            <div id="about">
