            ...
            <section className="price">
                ...
                <section className="price-box">
                    <article className="individual__price">
                        <h1 className="price-heading">₹1500 <small>per month</small></h1>
                    ...
                    <article className="individual__price">
                        <h1 className="price-heading">₹2500 <small>per month</small></h1>
                        <div className="paragraph card-paragraph">
                    ...
                    <article className="individual__price">
                        <h1 className="price-heading">₹3000 <small>per month</small></h1>
                        <div className="paragraph card-paragraph">
